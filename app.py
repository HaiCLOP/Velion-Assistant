...
# Function to listen for the wake-up word "Hey Velion"
...
if __name__ == '__main__':
    while True:
        if listen_for_wake_word():
            # Once "Hey Velion" is detected, the assistant starts listening for commands
            ...
            if "good bye" in statement or "ok bye" in statement or "stop" in statement or 'goodbye' in statement:
                ...
                speak("I am Velion, version 1.0, your personal assistant.")
            ...
            time.sleep(3)  # Small delay before the next loop iteration
